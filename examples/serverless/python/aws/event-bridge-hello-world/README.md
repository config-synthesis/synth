...
```bash
event-bridge-hello-world$ sam build --use-container
```
...
```bash
event-bridge-hello-world$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
event-bridge-hello-world$ sam logs -n HelloWorldFunction --stack-name event-bridge-hello-world --tail
```
...
```bash
event-bridge-hello-world$ pip install pytest pytest-mock --user
event-bridge-hello-world$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name event-bridge-hello-world
```
